...
Which gives the the following path:
...
The following table shows a selection of start and end individuals and whether a message can be forwarded between them:
